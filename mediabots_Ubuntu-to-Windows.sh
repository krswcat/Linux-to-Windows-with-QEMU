...
link1_status=$(curl -Is https://ia801508.us.archive.org/5/items/win101903v1japanesex64/Win10_1903_V1_Japanese_x64.iso | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is https://ia801508.us.archive.org/5/items/win101903v1japanesex64/Win10_1903_V1_Japanese_x64.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://ia801508.us.archive.org/5/items/win101903v1japanesex64/Win10_1903_V1_Japanese_x64.iso # Windows 10 
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots https://ia801508.us.archive.org/5/items/win101903v1japanesex64/Win10_1903_V1_Japanese_x64.iso
